...
const Navbar: FC = () => {
  ...
  return (
    <nav ref={navContainer} className="bg-slate-900 dark: py-5 transition-all">
          ...
          <ul className="flex gap-5 text-slate-700">
            <NavigationMenu>
              <NavigationMenuList className="flex justify-between">
                ...
                <NavigationMenuItem>
                  <Link to="/works" className={navigationMenuTriggerStyle()}>
                    <NavigationMenuLink>Works</NavigationMenuLink>
                  </Link>
                </NavigationMenuItem>
                <NavigationMenuItem>
                  <Link to="/career" className={navigationMenuTriggerStyle()}>
