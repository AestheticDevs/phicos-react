...
const Index: FC = () => {
  return (
    <>
      <section className="bg-slate-900 relative overflow-hidden py-8 xl:mb-5">
        <img
          src="/bg-overlay.png"
          alt=""
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden ">
        ...
        <div className="container relative z-1">
          ...
          <div className="grid grid-cols-2 items-center gap-x-24">
            <div>
              <img src={ImagePhicosGroup} alt="" className="h-full w-full" />
            </div>
      ...
      <section className="py-24 overflow-hidden relative">
        <div className="container mx-auto relative">
          <div className="mb-16 text-start">
            <h2 className="title font-semibold mb-2">Our Happy Clients </h2>
            <p className="text-slate-700 mb-8 text-sm opacity-50">
